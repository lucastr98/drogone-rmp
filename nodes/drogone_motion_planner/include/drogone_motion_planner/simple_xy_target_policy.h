...
#ifndef RMPCPP_POLICIES_SIMPLE_XY_TARGET_POLICY_H_
#define RMPCPP_POLICIES_SIMPLE_XY_TARGET_POLICY_H_
 ...
 */
template <int n>
class SimpleXYTargetPolicy : public PolicyBase<n> {
 ...
 public:
   ...
   */
  SimpleXYTargetPolicy(Vector target, Matrix A, double alpha, double beta, double c)
      : target_(target), alpha_(alpha), beta_(beta), c_(c) {
    this->A_ = A;
  }

  SimpleXYTargetPolicy(Vector target, double alpha, double beta, double c)
      : target_(target), alpha_(alpha), beta_(beta), c_(c) {}

  SimpleXYTargetPolicy(Vector target) : target_(target) {}
